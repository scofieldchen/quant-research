...
class STHMVRV(Metric):
    ...
    def __init__(
        ...
        metric_cols: Union[str, List[str]] = "sth_mvrv",
        smooth_period: int = 7,
        ...
        Args:
            ...
            metric_cols: DataFrame 中 STH-MVRV 列的名称
            smooth_period: 平滑窗口。
    ...
    def _add_indicator_traces(self, fig: go.Figure) -> None:
        ...
        add_percentile_bands(
            ...
            yaxis_title="STH-MVRV",
            metric_name="STH-MVRV",
            smooth_metric_name="Smooth STH-MVRV",
        )
